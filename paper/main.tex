...
In the full-scale model (6L/6H), head L0H2 emerges as an extreme outlier: threshold $0.152$ (vs.\ layer mean $0.012$), leak $0.661$ (vs.\ mean $0.368$), and steepness $3.25$ (vs.\ mean $2.01$). All three parameters are extreme in the same head, suggesting coordinated specialization rather than independent noise.
